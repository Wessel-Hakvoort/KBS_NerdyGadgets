    ...
    if ($StockItem != null) {
        ...
        <div id="ArticleHeader">
            ...
            <h2 class="StockItemNameViewSize StockItemName">
                ...
                ?>
                <br><br><br><br>
                <h5 style="color: #053d42">Gekoeld product!<br>De temperatuur
<!--                    is: --><?php
                    //$result = mysqli_query($databaseConnection, "SELECT Temperature FROM coldroomtemperatures WHERE ColdRoomSensorNumber = 5");
//                    $temperatuur = mysqli_fetch_array($result);
//                    print_r($temperatuur[0]);
                    print $temperatuur . '°C';
                    } } }?></h5>
                ...
                <div>
                    <form method="post">
                        <button style=" background:transparent; border:none;outline:none;display:block;" type="submit"
                            ...
                            <i style="font-size: 50px; color: red" class="fa-sharp fa-solid fa-heart"></i>
                        </button>
                    </form>
                    <br>
                    <?php
