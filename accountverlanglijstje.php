        ...
        <div id="FilterFrame" style="width: 350px">
            <div id="ResultsAreaWinkelmandje" class="Browse">
                ...
                if ($_SESSION["mail"] != "admin") {
                    ...
                    <hr>
                    <a style="padding-left:10px; font-size:25px;" href="accountverlanglijstje.php"
...
//print_r($verlanglijstje[0][0]);
    ...
    <div class="StockItemName" style="text-align: center">
        ...
        <br>
        <br>
        <h1>Het is op dit moment helaas niet mogelijk om een verlanglijstje aan te maken of te bekijken</h1>
        <br>
    </div>
